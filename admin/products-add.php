        ...
        <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-12 col-lg-12 col-md-12">
              <form action="admin_assets/includes/products-add.inc.php" method="POST" enctype="multipart/form-data" class="tm-edit-product-form">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="number" name="productprice" class="form-control validate" required />
                </div>

                <div class="form-group mb-3">
                  <label for="name">Product Image</label>
                  <input type="file" name="productimage" class="form-control validate" style="padding: 10px 10px;" required />
                </div>
            </div>
            <div class="col-12">
              <button type="submit" name="addproduct" class="btn btn-primary btn-block text-uppercase">Add Product</button>
            </div>
            </form>
          </div>
        </div>

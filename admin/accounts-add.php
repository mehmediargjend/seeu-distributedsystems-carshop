            ...
            <div class="row tm-content-row">
                <div class="col-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                        <h2 class="tm-block-title">Add User</h2>
                        <form action=" admin_assets/includes/accounts-add.inc.php" method="POST">
                            <div class="row">
                                <div class="col-md-12 mb-3" style="color: white;">
                                    ...
                                    <label for="" style="padding-top: 20px;">Password</label>
                                    ...
                                    <button type="submit" name="adduser" class="btn btn-primary" style="margin-top: 20px;">Add User</button>
                                </div>
                            </div>
                        </form>
                    </div>
